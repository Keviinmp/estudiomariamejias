...
// Interfaz para un servicio de uñas
...
export class ServicioService {
  ...
  // Array con los servicios del estudio
  ...
  private citas: Cita[] = [];
  private nextCitaId = 1; // Para generar IDs automáticamente
  ...
  getServicio(id: number): Observable<Servicio | undefined> {
